/*
 * FPGA Interface C API 21.3 header file.
 *
 * Copyright (c) 2021,
 ...
 * running and properly configured.  For NI-RIO 2.3 and later, refer to
 * Software>>NI-RIO>>NI-RIO Settings under the system in MAX. Prior to NI-RIO
 * 2.3, refer to Software>>NI-VISA>>VISA Options under the system in MAX.
 */
 ...
 * configured.  For NI-RIO 2.3 and later, refer to Software>>NI-RIO>>NI-RIO
 * Settings under the system in MAX. Prior to NI-RIO 2.3, refer to Software>>NI-
 * VISA>>VISA Options under the system in MAX.
 */
